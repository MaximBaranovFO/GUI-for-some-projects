 ...
 */
public class ZPINcThProcLoader implements Runnable, ZPINcThProcLoaderInterface {
    private boolean executed = false;
    private ZPINcThProcGUICallbackInterface proxyInstGuiCB;
    private boolean canceled = false;
    /**
     * Not used
     */
    protected ZPINcThProcLoader(){
