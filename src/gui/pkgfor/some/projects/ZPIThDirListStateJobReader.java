 ...
 */
public class ZPIThDirListStateJobReader {
    ...
    private ConcurrentSkipListMap<UUID, ZPITdataDirListFsObjAttr> readedData;
    
    protected ZPIThDirListStateJobReader(){
        ...
        this.readedData = new ConcurrentSkipListMap<UUID, ZPITdataDirListFsObjAttr>();
    }
    protected ZPIThDirListStateJobReader(Path pathForJob, URI fromFs){
    ...
    protected void putReadedData(final ConcurrentSkipListMap<UUID, ZPITdataDirListFsObjAttr> inputedData){
        this.readedSize = (int) inputedData.size();
        this.readedData.putAll(inputedData);
    }
    protected ConcurrentSkipListMap<UUID, ZPITdataDirListFsObjAttr> getReadedData(){
