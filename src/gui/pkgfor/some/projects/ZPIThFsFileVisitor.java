 ...
 */
public class ZPIThFsFileVisitor implements FileVisitor {
    ...
    protected ArrayBlockingQueue<ConcurrentSkipListMap<UUID, ZPITdataDirListFsObjAttr>> getBuffDirList(){
        return buffDirList;
    }
    ...
    private void makeListAttrForStorage(Object objectFile, BasicFileAttributes attrs){
        ConcurrentSkipListMap<UUID, ZPITdataDirListFsObjAttr> toPipe = new ConcurrentSkipListMap<UUID, ZPITdataDirListFsObjAttr>();
        ...
        ZPITdataDirListFsObjAttr attrEntity = new ZPITdataDirListFsObjAttr(
